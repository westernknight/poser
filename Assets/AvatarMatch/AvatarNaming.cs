...
public static class AvatarNaming
{
    ...
    public static BoneType GetBoneType(string boneName)
    {
        ...
        if (isBreast(boneName)) return BoneType.Breast;
    ...
    {
        return matchesNaming(boneName, typeTail) && !excludesNaming(boneName, tyoeExcludeBreast);
    }
    ...
    private static bool isBreast(string boneName)
    {
        return matchesNaming(boneName, typeBreast) && !excludesNaming(boneName, typeExcludeEye);
    }
